var urlWeather = window.location.hostname === 'localhost' ?
    ...
    'http://dublin-weather-app-dublin-weather.1d35.starter-us-east-1.openshiftapps.com/eidw';

var urlBuoy = window.location.hostname === 'localhost' ?
    'http://localhost:8001/dublinBuoy' :
    'http://dublin-weather-app-dublin-weather.1d35.starter-us-east-1.openshiftapps.com/dublinBuoy';

var urlDlData = window.location.hostname === 'localhost' ?
    'http://localhost:8001/dlData/current' :
    'http://dublin-weather-app-dublin-weather.1d35.starter-us-east-1.openshiftapps.com/dlData/current';

var urlDlWindData = window.location.hostname === 'localhost' ?
    'http://localhost:8001/dlData/wind' :
    'http://dublin-weather-app-dublin-weather.1d35.starter-us-east-1.openshiftapps.com/dlData/wind';
